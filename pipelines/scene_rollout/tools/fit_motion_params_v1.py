...
conditioned on walk/crouch/scope and action state. v1 uses the 32 Hz replay
contract by default; using 16 Hz halves fitted CS movement speeds.
"""
...
def main() -> None:
    ...
    ap.add_argument("--fps", type=float, default=32.0)
    ...
    out_path = args.out_dir / "motion_params_v1.json"

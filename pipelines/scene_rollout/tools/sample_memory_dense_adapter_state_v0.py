...
def main() -> None:
    ...
    ap.add_argument("--target-height", type=int, default=None, help="Force generation/input height, e.g. 480.")
    ap.add_argument("--target-width", type=int, default=None, help="Force generation/input width, e.g. 832.")
    args = ap.parse_args()
    ...
    if args.use_base_model and args.variant != "base":
        ...
        for expert_name, checkpoint_path in [
            ...
            encoder = MemoryDenseFrozenVAEWanTokenEncoder(
                ...
                vae=vae,
                vae_pth=vae_pth,
                native_hw=tuple(dense_encoder_cfg.get("native_hw") or [22, 40]),

...
def train(args: argparse.Namespace) -> dict[str, Any]:
    ...
    try:
        ...
        if args.w4_sampler_version is not None:
            ...
            elif lora_named_params or state_named_params or not adapter_named_params or not encoder_named_params:
                raise RuntimeError(
        ...
        non_lora_params = [p for _, p in adapter_named_params] + [p for _, p in encoder_named_params] + [p for _, p in state_named_params]
        if non_lora_params:

#!/usr/bin/env python3
"""Player dynamics v2: constant-velocity residual training, strict decode eval, and plots."""
...
def train_cmd(args: argparse.Namespace) -> None:
    ...
    manifest["target_representation"] = "v2_residual_from_constant_velocity_extrapolation"
    ...
    log_path = args.out_dir / "train_player_dynamics_v2.log"
    best_val = float("inf")
    step = 0
        ...
        while step < args.max_steps:
            for batch in train_loader:
                ...
                if step % args.eval_every == 0 or step == args.max_steps:
                    ...
                    torch.save(ckpt, args.out_dir / "last_player_dynamics_v2.pt")
                    if val_loss < best_val:
                        best_val = val_loss
                        torch.save(ckpt, args.out_dir / "best_player_dynamics_v2.pt")
...
def main() -> None:
    ...
    p.add_argument("--out-dir", type=Path, default=Path(str(source_path('scene', 'output/dynamics_v2/train_v2'))))

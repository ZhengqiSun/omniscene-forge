#!/usr/bin/env python3
# QXQ fixed copy of zhengqi tools/gen_tier69h_seed_v0.py (source sha256 642a78423aad4f9e8c67371b95a4b8bae8b71c03780ebc7b2a09041c423ab8f8).
# Fix (C1 structural): removed the hardcoded map_memory_split=train; every written row
# (tier20h seed passthrough AND supplement) now carries the canonical match-disjoint split
# from canonical_match_split_v0 (seed 20260531) with map_memory_split_key='match'.
# Report gains split_row_counts / relabelled counts. No other behavior change.
